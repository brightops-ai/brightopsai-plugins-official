...
4. Convert to base64 with `FileReader.readAsDataURL()`, return to the host, and save as `./data/images/{listing_id}.jpg`
...
// Then save: writeFileSync(`./data/images/${id}.jpg`, Buffer.from(b64, 'base64'))
```
